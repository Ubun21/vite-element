...
describe("Type", () => {
  it("Wriable", () => {
    expectTypeOf<Writeable<readonly [1, 2, 3]>>().toEqualTypeOf<[1, 2, 3]>();
    expectTypeOf<Writeable<Readonly<{ a: "b" }>>>().toEqualTypeOf<{
      a: "b";
    }>();
    expectTypeOf<Writeable<123>>().toEqualTypeOf<123>();
    expectTypeOf<
      Writeable<StringConstructor>
    >().not.toEqualTypeOf<StringConstructor>();
  });

  it("WriableArray", () => {
    expectTypeOf<WriteableArray<readonly [1, 2, 3]>>().toEqualTypeOf<
      [1, 2, 3]
    >();
    expectTypeOf<
      WriteableArray<BooleanConstructor>
  ...
  it("ResolvePropTypeResolvePropType", () => {
    expectTypeOf<
      ResolvePropType<BooleanConstructor>
